...
used_prompt = "sealed kraft - paper box"  # Change this to the prompt you want to analyze
used_prompt_with_underscore = "sealed_kraft_paper_box"  # Used for directory names
min_score = 0
